...
return array(
	...
	# Uncomment for 32-bit windows
	#'bin' => base_path() . '/wkhtmltopdf-windows/32/bin/wkhtmltopdf.exe',

	# Uncomment for 64-bit windows
	'bin' => base_path() . '/wkhtmltopdf-windows/64/bin/wkhtmltopdf.exe',
