	...
	<div class="panel-body" style="padding-bottom:0px;">
		 <div class="row">
		 	<div class="col-lg-12">
				<div class="row" style="margin: -10px -10px 0px -10px;">
					...
					<a href="{{action('Clients\ClientsController@getEditCompany',array('clientId'=>$customer->id))}}" class="btn btn-icon-only btn-circle blue pull-right" title="Edit Profile Information">
		 	...
		 	<div class="col-md-12 summary-profile-pic text-center">
				<a href="#" data-target=".socialProfile" data-toggle="modal" class="openModal">
					...
					@else
						<img id="main-profile-pic" src="{{url('public/admin/metronic/assets/global/img/summary_comp.png')}}" alt="profile pic" class="profilePic round-50"/>
					@endif
				</a>
			</div>
		 	<div class="col-md-12">
		 		<div class="description">
			 		...
			 		<p style="color:#428bca">{{ $customer->sector }}</p>
			 		@if( false )
		 ...
		 <div class="row">
		 	<div class="profilemenu">
			 	...
			 	<a href="#family" class="client_menu"><i class="icon-user"></i>People</a>
...
<div class="panel panel-default">
	<div class="panel-body">
		...
		<div class="row">
			<div class="col-md-12">
				<h6 style="font-weight: bolder;">About {{ $customer->company_name or 'Company' }}</h6>
