@if($customtab->section1==1)
  ...
  <div class="modal fade" id="section1notes-modal" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
...
@elseif($customtab->section1==2)
  <!-- modal for creating notes -->
  <div class="modal fade" id="section1files-modal" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content container-fluid">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">
