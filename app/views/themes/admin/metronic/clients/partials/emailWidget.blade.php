  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="ModalLabel">Sen Email Message to {{$currentClient->displayCustomerName()}}</h4>
      </div>
                ...
                <form class="inbox-compose form-horizontal" id="fileupload" action="{{url('email/client',array('customer'=>$customer->id))}}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="inbox-form-group mail-to">
                    ...
                    <div class="controls controls-to">
                      <select id="select2_user" class="form-control select2" multiple placeholder="Se;ect Customer's Email">
                        @if( $email->count() > 1 )
