		...
		<div class="page-container">
			...
			<div class="page-content-wrapper">
				<div class="page-content">
					<!-- BEGIN PAGE HEADER-->
					<!-- Dashboard Title -->
					@include( \DashboardEntity::get_instance()->getView() . '.dashboard.partials.pageTitle' )
					<!-- Dashboard Title -->
					<h3 class="page-title">
					...
					<div class="nav-justified">
						...
						<div class="tab-content">
							<div id="quick_sidebar_tab_1" class="tab-pane active page-quick-sidebar-chat">
								<div class="page-quick-sidebar-list" style="position: relative; overflow: hidden; width: auto; height: 319px;"><div data-wrapper-class="page-quick-sidebar-list" data-rail-color="#ddd" class="page-quick-sidebar-chat-users" data-height="319" style="overflow: hidden; width: auto; height: 319px;" data-initialized="1">
								...
								</div><div class="slimScrollBar" style="background: none repeat scroll 0% 0% rgb(187, 187, 187); width: 7px; position: absolute; top: 0px; opacity: 0.4; border-radius: 7px; z-index: 99; right: 1px; height: 134.249px; display: block;"></div><div class="slimScrollRail" style="width: 7px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: none repeat scroll 0% 0% rgb(221, 221, 221); opacity: 0.2; z-index: 90; right: 1px;"></div></div>
								<div class="page-quick-sidebar-item">
									<div class="page-quick-sidebar-chat-user">
										<div class="page-quick-sidebar-nav">
											<a class="page-quick-sidebar-back-to-list" href="javascript:;"><i class="icon-arrow-left"></i>Back</a>
										</div>
										<div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 214px;"><div class="page-quick-sidebar-chat-user-messages" data-height="214" style="overflow: hidden; width: auto; height: 214px;" data-initialized="1">
											<div class="post out">
										...
										</div><div class="slimScrollBar" style="background: none repeat scroll 0% 0% rgb(187, 187, 187); width: 7px; position: absolute; top: 0px; opacity: 0.4; border-radius: 7px; z-index: 99; right: 1px; height: 66.1792px; display: block;"></div><div class="slimScrollRail" style="width: 7px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: none repeat scroll 0% 0% rgb(234, 234, 234); opacity: 0.2; z-index: 90; right: 1px;"></div></div>
							...
							<div id="quick_sidebar_tab_2" class="tab-pane page-quick-sidebar-alerts">
								<div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 319px;"><div class="page-quick-sidebar-alerts-list" data-height="319" style="overflow: hidden; width: auto; height: 319px;" data-initialized="1">
							...
							<div id="quick_sidebar_tab_3" class="tab-pane page-quick-sidebar-settings">
								<div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 319px;"><div class="page-quick-sidebar-settings-list" data-height="319" style="overflow: hidden; width: auto; height: 319px;" data-initialized="1">
