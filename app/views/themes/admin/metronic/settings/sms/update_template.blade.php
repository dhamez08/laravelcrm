						...
						<div class="row">
							<div class="col-md-12">
								{{
									Form::open(
										array(
											'url'	=>	'settings/sms/update-template/'.$id
										)
									)
								}}	
								<div class="form-body">
									...
									<div class="row">
										<div class="col-md-9">
											...
											<textarea class="form-control" name="template_body" id="template_body" rows="10">{{ $body }}</textarea>
											</div>
										</div>
									...
									<div class="pull-right">
										...
										<a href="{{ url('settings/sms') }}" class="btn red">Cancel</a>
									</div>
								</div>
								{{ Form::close() }}
						</div>
