<?php
namespace UserProfilePhoto;
/**
* UserProfilePhoto Controller
*
* */
use \Carbon\Carbon;
  ...
  protected $fileFolder;
    ...
    */
    ...
    public function getChangephoto(){
      ...
      $change = \User\User::find($accnt);
      $change->profile_image = $id;
      $change->save();

      if($id > 0){
        $photo = \UserProfileImages\UserProfileImages::where('id','=',$id)->first();
        if(count($photo) == 0){
          $profile_photo_id = 0;
    ...
    public function postUpload(){
      $url = \Input::get('url');
      $user = \Input::get('user_id',\Auth::id());
