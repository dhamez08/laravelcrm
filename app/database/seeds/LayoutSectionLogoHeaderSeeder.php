    ...
    public function run()
    {
        ...
        DB::table('system_layout_section')->insert(array(
            ...
            array(
                ...
                'source_code' => htmlentities('<div class="section-area" style="background: #FFFFFF; margin: 0 auto; width: 750px; font-family: Helvetica; font-weight: bold"> <div class="inner-section" style="padding: 15px; padding-bottom: 30px; position: relative"> <div class="editable-box" style="background-color: #ACACAC; width: 700px; display: inline-block; vertical-align: top; font-size: 14px; padding-top: 10px; color: rgb(103, 123, 124); text-align: right; padding-bottom: 10px; margin-top: 20px;"> <div style="padding: 20px; display: inline-block"> <a class="editable editable-url" data-color="HeaderLogoLink" target="_blank" contenteditable="true">Home Page</a> </div> <div style="padding: 20px; display: inline-block"> <a class="editable editable-url" data-color="HeaderLogoLink" target="_blank" contenteditable="true">Contact Us</a> </div> <div style="padding: 20px; display: inline-block"> <a class="editable editable-url" data-color="HeaderLogoLink" target="_blank" contenteditable="true">Inquire</a> </div> </div> <div class="overlay-position" style="width: 200px; display: inline-block; font-size: 15px; text-align: center; position: absolute; left: 20px; top: 5px"> <img class="editable editable-photo" src="http://zeromyexcess.co.uk/laravelcrm/public/img/template_builder/headers/logo-headers/logo_medium.jpg"> </div> </div> </div>')
            ),
            array(
                'layout_id' => 12,
                'group_id' => 6,
                ...
                'source_code' => htmlentities('<div class="section-area" style="background: #FFFFFF; margin: 0 auto; width: 750px; font-family: Helvetica; font-weight: bold"> <div class="inner-section" style="padding: 15px; padding-bottom: 30px; position: relative"> <div class="editable-box" style="background-color: #ACACAC; width: 700px; display: inline-block; vertical-align: top; font-size: 14px; padding-top: 10px; color: rgb(103, 123, 124); text-align: right; padding-bottom: 10px; margin-top: 20px;"> <div style="padding: 20px; display: inline-block"> <a class="editable editable-url" data-color="HeaderLogoLink" target="_blank" contenteditable="true">Home Page</a> </div> <div style="padding: 20px; display: inline-block"> <a class="editable editable-url" data-color="HeaderLogoLink" target="_blank" contenteditable="true">Contact Us</a> </div> <div style="padding: 20px; display: inline-block"> <a class="editable editable-url" data-color="HeaderLogoLink" target="_blank" contenteditable="true">Inquire</a> </div> </div> <div class="overlay-position" style="width: 200px; display: inline-block; font-size: 15px; text-align: center; position: absolute; left: 20px; top: 5px"> <img class="editable editable-photo" src="http://zeromyexcess.co.uk/laravelcrm/public/img/template_builder/headers/logo-headers/logo_medium.jpg" style="border-radius: 70px !important"> </div> </div> </div>')
            ),
        ));
    }
